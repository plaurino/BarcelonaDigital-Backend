            ...
            $mdBottomSheet.show({
                ...
                controller: function($scope){
                    ...
                    $scope.setAsAdmin = function() {
                        ...
                        var title = 'Realmente deseas que ' + user.username + ' sea un usuario estándar?';
                        var msg = 'Ahora ' + user.username + ' es un usuario estándar.';
                        ...
                        $mdDialog.show(confirm).then(function () {
                            ...
                            $mdToast.show(
                                $mdToast.simple()
                                    .content('La acción ha sido cancelada.')
                                    .position('top right')
                                    .hideDelay(3000)
                            );
                        });
